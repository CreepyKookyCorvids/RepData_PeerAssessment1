...
As you can see, our mean of `r format(mean(impdayssummed$x), digits = 7)` steps per day is nearly equal to the data's median at `r median(impdayssummed$x)` steps per day.
